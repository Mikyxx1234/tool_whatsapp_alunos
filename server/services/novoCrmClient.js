...
/** Teto global de req/s (sync, enrich, tags). Default 2; teto 6 (catch-up Full Sync). Att no dia-a-dia: 2. */
function apiRatePerSecond() {
  return Math.max(1, Math.min(6, Number(process.env.NOVO_CRM_API_RATE_PER_SECOND) || 2));
}
